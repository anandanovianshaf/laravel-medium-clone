<nav x-data="{ open: false }" class="sticky top-0 z-50 backdrop-blur-md bg-[#0B1120]/80 border-b border-[#23304A]">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="-me-2 flex items-center sm:hidden">
                    <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-slate-400 hover:text-slate-200 hover:bg-[#162032] focus:outline-none focus:bg-[#162032] focus:text-slate-200 transition duration-150 ease-in-out">
